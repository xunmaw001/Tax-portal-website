...
var centerMenu = [
    ...
    ,{
        name: '税务欠款',
        url: '../shuiwuqiankuan/listdata.html'
    }
    ,{
        name: '政策文件收藏',
        url: '../zhegncewenjianCollection/list.html'
    }
    ,{
        name: '政策解读收藏',
        url: '../zhengcejieduCollection/list.html'
    }
    ...
    ,{
        name: '违法税收检举',
        url: '../weifashuishou/listdata.html'
    }
    ,{
        name: '纳税服务投诉',
        url: '../nashuifuwutousu/listdata.html'
    }
    ,{
        name: '意见征集',
        url: '../yijianzhengji/listdata.html'
    }
...
var indexNav = [
    ...
    {
        name: '人事任免',
        url: './pages/renshirenmian/list.html'
    },
    {
        name: '单位信息',
        url: './pages/danweixinxi/list.html'
    },
    ...
    {
        name: '政策文件',
        url: './pages/zhegncewenjian/list.html'
    },
    /*{
        name: '政策解读',
        url: './pages/zhengcejiedu/list.html'
    },*/
    {
        name: '热点问答',
...
var adminurl =  "http://localhost:8080/shuiwumenhuwangzhan/admin/dist/index.html#/login";
